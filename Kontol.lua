...
Changelog:addChangelog('- Remove Auto Collect Gift')
Changelog:addChangelog('- Remove Auto Store Gift')
Changelog:addChangelog('')

Changelog:addChangelog('[April, 20 2025]')
Changelog:addChangelog('- Added NPC Teleport')
Changelog:addChangelog('- RemoveCandies Shop on Shop')
Changelog:addChangelog('')
